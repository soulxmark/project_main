...
protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
    ...
    // Handle financial statement view
    String view = req.getParameter("view");
    if ("master".equals(view)) {
        ...
        req.getRequestDispatcher("/WEB-INF/views/financial-statement.jsp").forward(req, resp);
        return;
    }

    // Rest of your existing code (dashboard logic)
    BigDecimal totalIncome = reportDAO.getTotalIncome();
    BigDecimal totalExpense = reportDAO.getTotalExpense();
    BigDecimal netProfit = totalIncome.subtract(totalExpense);
